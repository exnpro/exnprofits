...
export default {
  ...
  data: () => ({
    ...
    newUsers: [],
    users: [
      { name: "Bevilacqua ", amount: 10000 },
      { name: "Gracie", amount: 20333 },
      { name: "Eno ", amount: 90086 },
      { name: "Willette", amount: 12345 },
      { name: "Tinder", amount: 90099 },
      { name: "Hertha", amount: 56000 },
      { name: "Tong ", amount: 1021 },
      { name: "Margaret", amount: 56000 },
      { name: "Gleeson", amount: 8000 },
      { name: "Jacques", amount: 70050 },
...
.gpop {
  ...
  background: linear-gradient(36deg, rgb(0, 0, 0) 14%, rgb(51, 51, 51) 87%);
}
</style>
