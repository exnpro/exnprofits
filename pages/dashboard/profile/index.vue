            ...
            <v-row align="center">
              ...
              <v-col cols="12" sm="6">
                <div
                  ...
                  "
                >
                  <v-icon color="primary" class="mx-2"> mdi-account </v-icon>
                  <span
                    class="
                      headline
                      font-weight-medium
                ...
                >
                  <v-icon color="primary" class="mx-2"> mdi-bitcoin </v-icon>
                  <span class="text-subtitle-1 d-inline-block text-truncate">{{
                    user !== null ? user.walletAddress : "wallet address"
                  }}</span>
                </div>
              </v-col>
              <v-spacer />
...
export default {
  ...
  head() {
    return {
      title:
        this.user !== null ? this.user.username + "Profile" : "Your Profile",
      meta: [
  ...
  methods: {
    ...mapActions({
      ...
      uploadPhoto: "authentication/uploadPhoto",
      updateWalletAddress: "authentication/updateWalletAddress",
      updatePsw: "authentication/updatePassword",
      initAlert: "authentication/initAlert",
    }),
      ...
      if (this.password.old === this.user.password) {
        if (this.password.new !== this.user.password) {
          ...
          this.initAlert({
            is: true,
            type: "error",
            message: "new password can't be thesame with old password",
          });
        }
      } else {
        this.initAlert({
