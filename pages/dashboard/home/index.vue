        ...
        <v-card dark flat tile color="primary darken-1">
          ...
          <v-card-text class="d-flex">
            <div class="d-flex flex-column">
              ...
              <span class="text-h6 white--text font-weight-light"
                ...
                <v-row>
                  <v-col cols="12" class="">
                    ...
                    <v-btn color="primary" small outlined class="mx-2">
                      <v-icon class="mr-2" small> mdi-buffer </v-icon>
                      {{ user && user.lastLogin }}
                    </v-btn>
                  </v-col>
                  <v-col cols="12" class="">
                  ...
                  <v-col cols="12" class="textWhite--text">
                    Device Browser:
                    <v-btn color="primary" small outlined class="mx-2">
                      <v-icon class="mr-2" small> mdi-web </v-icon>
                      {{ browser }}
                    </v-btn>
                  </v-col>
                  <v-col cols="12">
      ...
      return [
        {
          ...
          to: "",
          amount:
            (this.user && this.user.wallet.deposit) +
            (this.user && this.user.wallet.earnings),
        },
        {
          ...
          type: "text",
          color: "gblue",
          info: "Current Signal Strength",
          to: "",
          text: this.user && this.user.signal,
        },
      ];
    },
    wallets2() {
      return [
        ...
        },
        {
          ...
          color: "gblue",
          to: "",
          info: "Current Trading Level",
          text: this.user && this.user.tradeLevel,
        },
      ];
    },
  },
