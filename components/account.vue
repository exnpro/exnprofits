  ...
  <div>
    ...
    >
      <template v-slot:header>
        ...
        <v-menu v-if="type !== 'admin'" left bottom>
      ...
      <v-row class="ma-0" justify="space-around">
        <v-col cols="12" sm="4" class="d-flex align-center justify-center">
          ...
          >
            <img src="/tradestation.png" alt="Exness Profit.org" />
          </v-avatar>
        ...
        <v-col cols="12" sm="6">
          ...
          <v-divider class="my-1" />
          <div class="d-flex text-subtitle-2">
            <span class="font-weight-medium"> Account Mananger </span>
            <v-spacer />
            <span class="font-weight-bold blue-grey--text text--lighten-4">
