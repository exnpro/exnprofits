<template>
  <v-container fluid class="pa-0 overflow">
    <v-row
      justify="center"
      class="bg-crypto align-center px-md-16 px-4 py-16 primary ma-0"
    >
...
export default {
  ...
  data: () => ({
    policies: [
      ...
      {
        name: "How Do Cryptocurrencies Work?",
        delay: 500,
        description: `
      ...
      {
        name: "Are There Investment Opportunities with Cryptocurrencies?",
        delay: 500,
        description: `
    ...
    return {
      ...
      meta: [
        // hid is used as unique identifier. Do not use `vmid` for it as it will not work
        {
          ...
          name: "description",
          content:
            "Exness Profit is excited to announce the launch of our new cryptocurrency trading platform. ",
        },
      ],
    };
  },
...
.bg-crypto {
  background: linear-gradient(
      0deg,
      rgba(49, 1, 131, 0.9) 47%,
      rgba(156, 19, 223, 0.9) 87%
    ),
    url("/bg/dash.jpg");
