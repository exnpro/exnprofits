                  ...
                  <v-chip label color="accent ml-2">
                    <div v-if="user && user.wallet.earnings !== 0">
                      {{ currency
                        ...
                        rateAmount(user && user.wallet.earnings) | currency
                      }}
                    </div>
                    <div v-else>{{ currency }}0.00</div>
                  </v-chip>
                  <v-spacer />
                  <v-btn
                    depressed
                      ...
                      <v-row v-else class="ma-0">
                        <v-col cols="12">
                          ...
                          <v-btn
                            color="accent"
                            text
                            href="mailto:support@exnessprofit.online"
                            class="px-0 text-lowercase"
                          >
                            support@exnessprofit.online
                          </v-btn>
