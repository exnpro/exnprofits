<template>
  <v-container fluid class="pa-0 overflow">
    <v-row
      justify="center"
      class="bg-forex align-center px-md-16 px-4 py-16 primary ma-0"
    >
      <v-col cols="12" class="text-center pl-md-10 my-6 mb-12">
        ...
        <div class="text-h6 white--text font-weight-light mt-5">
          Trade forex on the Exness Profit platform and enjoy reliable pricing
...
<style>
.bg-forex {
  background: linear-gradient(rgba(0, 149, 255, 0.6), rgba(0, 149, 255, 0.6)),
    url("/assets/bgcash.jpg");
